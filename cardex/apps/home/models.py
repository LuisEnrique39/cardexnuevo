...
class SolicitudVacaciones(models.Model):
    ...
    dias_usados = models.PositiveIntegerField()  # Campo para registrar los días utilizados en la solicitud de vacaciones
    dias_restantes = models.PositiveIntegerField()  # Campo para registrar los días restantes
    anios_servicio = models.IntegerField(default=0)


    def __str__(self):
        return f"Solicitud de vacaciones de {self.user} ({self.inicio} - {self.final})"
